    ...
    public class SelectSubjectClassActivity extends AppCompatActivity {
...
//                        .getString("teacherId", "");
                currentTeacherId = "3Qg8wao2SSXnRtg9XfSKIo4BsUZ2"; // lấy 1 id có trong DB
            ...
            realtimeDb.child("Subjects")
                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onCancelled(@NonNull DatabaseError error) {
                            showLoading(false);
                            Toast.makeText(SelectSubjectClassActivity.this,
...
//                                    }
        ...
        private void setupClassSpinner() {
            ...
            classNames.add("-- Chọn lớp học --"); // Mục mặc định
        ...
        private void setupListeners() {
            ...
            btnContinue.setOnClickListener(v -> {
                if (selectedSubject != null && selectedClassSubject != null) {
                    ...
                    Intent intent = new Intent(SelectSubjectClassActivity.this, TeacherInputGradesActivity.class); // Thay bằng Activity của bạn
                    intent.putExtra("SUBJECT_ID", selectedSubject.subjectId);
